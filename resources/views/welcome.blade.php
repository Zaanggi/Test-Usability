<!DOCTYPE html>
  <html lang="en">
    <head>
      ...
      <title>Layanan Pengaduan Telkom </title>
    ...
    <body>
       <section class="abovefold overflow-hidden">
        ...
        <div class="container header position-relative">
            <div class="row">
                <div class="col-lg-10 px-md-0 my-auto">
                    <div class="headline">
                        Layanan Pengaduan Telkom 
                    </div>
                    <div class="sub-headline">
                        Mudah, cepat dan tanggap
                    </div>
                    <div class="d-flex gap-4 mt-5">
                        <a href="#laporkan" class="btn btn-contact">
                            Laporkan
                          </a>
                      </div>
                    <div class="row four-point">
                        <div class="col-md-6">
                            <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/dark/Vector.png"
                                alt="vector" class="me-3"> Keluhan Pelayanan
                        </div>
                        <div class="col-md-6">
                            <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/dark/Vector.png"
                                alt="vector" class="me-3"> Keluhan Gangguan
                        </div>
    ...
    <style scoped>
      * {
      ...
      .dropdown-menu {
          max-height: 300px; /* Atur tinggi maksimum dropdown */
          overflow-y: auto; /* Aktifkan scrolling jika kontennya melebihi tinggi maksimum */
        }
    ...
    <div class="container">
      <div class="row d-block mx-0">
          ...
          <div class="card" style="background-color : #3b3333">
              <div class="card-body">
                 <form action="{{route('pengaduan.store')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-12 mb-3">
                          <div class="form-group">
                            ...
                            <select name="lokasi" class="form-control" onmousedown="setDropdownScrollable(this)" onchange="closeDropdown(this)">
                        ...
                        <div class="col-md-12 mb-3">
                          <div class="form-group">
                            ...
                            <select name="keterangan" class="form-control" onmousedown="setDropdownScrollable(this)" onchange="closeDropdown(this)">

                              <option value="">Pilih Keterangan</option>
                              <option>Alat Bermasalah</option>
                              <option>Jaringan Bermasalah</option>
                              <option>Kabel Jaringan Terputus</option>
                              <option>Kualitas panggilan suara yang buruk dan sering terputus-putus</option>
                              <option>Layanan Mengalami Kenaikan Harga</option>
                              <option>Layanan Mengalami Penurunan Kualitas Jaringan</option>
                              <option>Layanan pelanggan yang lambat dan sulit dihubungi</option>
                              <option>Permasalahan Jaringan Lemot</option>
                              <option>Pemutusan sementara layanan internet tanpa pemberitahuan sebelumnya</option>
                              <option>Putus Layanan Pelanggan</option>
                              <option>Sinyal telepon seluler yang sering hilang atau lemah</option>
                              <option>Tidak adanya tindakan perbaikan atau peningkatan infrastruktur jaringan</option>
                              <option>Tidak Ada Sinyal</option>

                              <!-- Tambahkan pilihan keterangan lainnya di sini -->
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="col text-right">
                              <button type="submit" class="btn px-5" style="background-color: #cf0c0c; color :white">
                                  Laporkan
                              </button>
                          </div>
                      </div>
        ...
        <div class="card rounded-lg">
          <div class="card-body">
            <div class="card-desc">
              ...
              <p class="card-text">Pilih jenis laporan kendala yang dialami 
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid text-md-left">
        <div class="row">
            <div class="col-md-5 mt-md-0 mt-3">
                <h3 class="font-weight-bold mb-4">Telkom </h3>
                <p class="mb-2">
                    Jakarta
                </p>
                <p>
      ...
      <script>
        function setDropdownScrollable(dropdown) {
          dropdown.size = dropdown.length > 6 ? 6 : dropdown.length;
        }
